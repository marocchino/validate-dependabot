...
function validateDependabot(path, successMessage, failureMessage) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // load schema
        const response = yield (0, node_fetch_1.default)('https://json.schemastore.org/dependabot-2.0.json');
...
function Ajv(opts) {
  ...
  function addDraft4MetaSchema() {
    if (self._opts.meta !== false) {
      var metaSchema = __nccwpck_require__(7171);
...
function enableV5(ajv) {
  ...
  if (ajv._opts.meta !== false) {
    var metaSchema = __nccwpck_require__(7722);
